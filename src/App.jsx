...
function InfoTip({ text }) {
  ...
  return (
    ...
    >
      <span style={{ width: 13, height: 13, borderRadius: '50%', border: '1px solid #ccc', color: '#aaa', fontSize: 9, fontWeight: 400, fontFamily: 'Georgia, serif', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', cursor: 'default', userSelect: 'none', lineHeight: 1 }}>i</span>
      {show && (
